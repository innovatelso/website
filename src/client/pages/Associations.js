...
const Associations = () => (
    <Layout>
        ...
        <div>
            {/* BIBA */}
            <h3 className="text-2xl text-purple">BIBA</h3>
            <span className="text-2xl">Member, Director and 1st VP</span>
            <p className="my-4">
            ...
            {/* FEIFA */}
            <h3 className="text-2xl text-purple">FEIFA</h3>
            <span className="text-2xl">Associate Member</span>
            <p className="my-4">
            ...
            {/* JV Harmony */}
            <h3 className="text-2xl text-purple">JV Harmony</h3>
            <span className="text-2xl">Barbados Chapter Lead & Member</span>
            <p className="my-4">
