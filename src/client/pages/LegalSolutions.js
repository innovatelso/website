    ...
    <Layout pin={false} className="md:mt-10">
        ...
        <div className="md:w-2/3">
            ...
            <p className="my-4">
                ...
                We work with multi-national companies and also with smaller ventures seeking to set up or relocate businesses to Barbados. <br />
                We provide a one-stop shop, from corporate services to the hiring of employees and sourcing office accommodation.
                Our professionals will provide guidance if work permits are required. <br />
